...
public class Configuration {
  ...
  // TODO: Return an ancestor of Configuration? To be able to add more prometheus-version-specific
  // configurations
  ...
  public static Configuration allMetrics() {
    return new Configuration(
        true /* isIncludeLatencyHistograms */, DEFAULT_LATENCY_BUCKETS, new ArrayList<>(), false);
  }
  ...
  public Configuration withLatencyBuckets(double[] buckets) {
    return new Configuration(
        isIncludeLatencyHistograms, buckets, labelHeaders, isAddCodeLabelToHistograms);
  }
  ...
  public Configuration withLabelHeaders(List<String> headers) {
    ...
    return new Configuration(
        isIncludeLatencyHistograms, latencyBuckets, newHeaders, isAddCodeLabelToHistograms);
  }
