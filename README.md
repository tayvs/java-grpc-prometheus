...
This library is made available on
the [dinowernli GitHub Maven repository](https://github.com/dinowernli/maven-repos/tree/master).
...
In order to attach the monitoring server interceptor to your gRPC server with a custom collector registry, you can do
the following:
...
In order to attach the monitoring client interceptor to your gRPC client with a custom collector registry, you can do
the following:
...
If you're using Spring Boot 2 with micrometer-registry-prometheus you should inject the CollectorRegistry that is
already provided in the application context:
