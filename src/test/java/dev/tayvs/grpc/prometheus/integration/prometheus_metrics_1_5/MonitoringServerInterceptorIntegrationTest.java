 ...
 * grpc_server_ prefix is baked into each metric name (e.g. grpc_server_started).
 */
public class MonitoringServerInterceptorIntegrationTest {
  ...
  public void serverStreamRpcMetrics() throws Throwable {
    ...
    FamilySamples messagesSent = findRecordedMetricOrThrow("grpc_server_msg_sent");
  ...
  public void noHistogramIfDisabled() throws Throwable {
    ...
    assertThat(
            PrometheusRegistryHelper.findRecordedMetric(
                    "grpc_server_handled_latency_seconds", prometheusRegistry)
                .isPresent())
        .isFalse();
  }
  ...
  public void addsHistogramIfEnabled() throws Throwable {
    ...
    FamilySamples latency = findRecordedMetricOrThrow("grpc_server_handled_latency_seconds");
  ...
  public void overridesHistogramBuckets() throws Throwable {
    ...
    assertThat(countSamples("grpc_server_handled_latency_seconds", "grpc_server_handled_latency_seconds_bucket"))
        .isEqualTo(expectedNum);

    FakeSample sample =
        getSample(
            findRecordedMetricOrThrow("grpc_server_handled_latency_seconds"), "grpc_server_handled_latency_seconds_bucket");
  ...
  public void recordsHeadersAsLabels() throws Throwable {
    ...
    assertThat(findRecordedMetricNamesOrThrow("grpc_server_started")).contains("grpc_server_started_total");
    assertThat(findRecordedMetricNamesOrThrow("grpc_server_started")).contains("grpc_server_started_created");
    FakeSample sample = getSample(findRecordedMetricOrThrow("grpc_server_started"), "grpc_server_started_total");
    assertThat(sample.labelNames)
