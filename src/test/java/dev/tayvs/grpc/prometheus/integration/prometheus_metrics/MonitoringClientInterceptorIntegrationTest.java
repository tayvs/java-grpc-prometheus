 ...
 *
 * <p>Note: metric names in this module omit the grpc_client_ prefix because the prometheus-metrics
...
public class MonitoringClientInterceptorIntegrationTest {
  ...
  public void unaryRpcMetrics() throws Throwable {
    ...
    assertThat(getSample(findRecordedMetricOrThrow("started"), "started_total").value)
        .isWithin(0)
        .of(1);
  ...
  public void clientStreamRpcMetrics() throws Throwable {
    ...
    assertThat(getSample(findRecordedMetricOrThrow("msg_sent"), "msg_sent_total").value)
        .isWithin(0)
        .of(2);
  ...
  public void serverStreamRpcMetrics() throws Throwable {
    ...
    assertThat(getSample(findRecordedMetricOrThrow("msg_received"), "msg_received_total").value)
        .isWithin(0)
        .of(1);
  ...
  public void noHistogramIfDisabled() throws Throwable {
    ...
    assertThat(
            PrometheusRegistryHelper.findRecordedMetric(
                    "completed_latency_seconds", prometheusRegistry)
                .isPresent())
        .isFalse();
  }
  ...
  public void overridesHistogramBuckets() throws Throwable {
    ...
    assertThat(countSamples("completed_latency_seconds", "completed_latency_seconds_bucket"))
